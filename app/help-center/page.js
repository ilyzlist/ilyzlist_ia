...
export default function HelpCenterScreen() {
  ...
  return (
    <>
      <div className="help-center-container bg-white rounded-[30px] max-w-md mx-auto min-h-screen p-6 pb-24">
        {/* Header with Back Button */}
        <header className="flex items-center mb-8">
          <button onClick={() => router.back()} className="mr-4 text-[#3742D1]" aria-label="Back">
        ...
        <section className="mb-8">
          ...
          <div className="space-y-3">
            ...
            >
              <FaEnvelope className="text-[#3742D1] text-xl mr-3" />
            ...
            >
              <FaComments className="text-[#3742D1] text-xl mr-3" />
