...
export default function SettingsPage() {
  ...
  // Password form state (email/password users only)
  ...
  // Load user + profile (notifications_enabled + provider)
  useEffect(() => {
    (async () => {
      ...
      // read notifications flag; default true if column missing
  ...
  return (
    <>
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-50 bg-[#3742D1] py-2 px-6
                      flex justify-around max-w-md mx-auto rounded-t-2xl shadow-lg
